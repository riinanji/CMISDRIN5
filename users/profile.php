...
if (isset($_POST['submit'])) {
    ...
    $state = $_POST['state'];
    $query = mysqli_query($bd, "update tbl_user set fullName='$fname',contactNo='$contactno',address='$address',State='$state' where userEmail='" . $_SESSION['login'] . "'");
    if ($query) {
            ...
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        ...
                        <?php
                        $query = mysqli_query($bd, "select * from tbl_user where userEmail='" . $_SESSION['login'] . "'");
                        while ($row = mysqli_fetch_array($query)) {
                            ?>

                            <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['fullName']); ?>'s
                                Profile</h4>
                            ...
                            <form class="form-horizontal style-form" method="post" name="profile">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Zone</label>
                                    <div class="col-sm-4">
